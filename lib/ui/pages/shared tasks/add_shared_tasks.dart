...
class AddToShared extends StatefulWidget {
  final String groupID;

  AddToShared({this.groupID});
  @override
  _AddToSharedState createState() => _AddToSharedState();
}

class _AddToSharedState extends State<AddToShared> {
  String title = '';
  String description = '';
  static String error = '';
                  ...
                  onPressed: () {
                    setState(() {
                      if (_text.text.length > 25) {
                        ...
                        DBServices()
                            .addSharedTask(title, description, widget.groupID);
